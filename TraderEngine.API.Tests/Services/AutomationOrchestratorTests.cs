...
[TestClass]
public class AutomationOrchestratorTests
{
  ...
  public void IsEligibleForRebalance_NoOrders_ReturnsFalse()
  {
    ...
    // Act
    var result = AutomationOrchestrator.IsEligibleForRebalance(configReqDto, simulated);
  ...
  public void HasNonContiguousFullSellOrder_SmallestAllocationFullSell_ReturnsFalse()
  {
    ...
    // Act
    var result = AutomationOrchestrator.HasNonContiguousFullSellOrder(configReqDto, simulated);
